this.Processor = class Processor {
  ...
  logWarning(message, file = null, line = null) {
    if (this.listener && this.listener.reportWarning) {
      this.listener.reportWarning({ message: message, file: file, line: line });
    } else if (this.listener && this.listener.log) {
  ...
  run(context) {
    var a, arg1, args, argv, b, c, call_stack, call_stack_index, call_super, call_supername, con, cs, err, f, fc, field, file, global, i, i1, i2, id, index, ir, iter, iterator, j, k, key, l, len, length, line, local_index, locals, locals_offset, loop_by, loop_to, m, n, name, o, obj, object, op_count, op_index, opcodes, p, parent, q, r, rc, ref, ref1, ref10, ref11, ref12, ref13, ref14, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, res, restore_op_index, routine, s, sleep_time, src, stack, stack_index, sup, t, token, u, v, value, w;
          ...
          if (op_count++ > 100) {
            ...
            if (Date.now() > this.time_limit) {
              if (!this.warning_shown) {
                ...
                file = token?.tokenizer?.filename;
                line = token?.line;
                this.logWarning("Long-running loop detected - execution throttled", file, line);
